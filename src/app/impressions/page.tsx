...
export default function ImpressionsPage() {
  ...
  // Map Data
  // "Sessions" = Total Prompts (Proxy for interaction sessions)
  // "Unique" = Active Users
  const totalSessions = data.metrics.total;
  const totalUnique = data.metrics.uniqueUsers;
  // Avg Duration -> Avg Processing Time? Or undefined. "4m 32s" was mock.
  // We don't have session duration. Let's use Avg Processing Time as "System Latency".
  const avgProcessing =
